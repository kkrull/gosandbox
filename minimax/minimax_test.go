...
func (game *GameWithKnownStates) AvailableMoves() []Move {
	return game.nextMoves
}

func (game *GameWithKnownStates) Move(selectedMove Move) Game {
...
func (game *GameWithKnownStates) FindWinner() Player {
	return game.winner
}
