...
var _ = Describe("Minimax", func() {
	...
	It("bounds the score for the maximizing player as the maximum score among all possible outcomes", func() {
		game := FakeGame{
			nextGames:[]Game{
	...
	It("bounds the score for the minimizing player as the minimum score among all possible outcomes", func() {
		game := FakeGame{
			nextGames:[]Game{
				FakeGame{isOver: true},
